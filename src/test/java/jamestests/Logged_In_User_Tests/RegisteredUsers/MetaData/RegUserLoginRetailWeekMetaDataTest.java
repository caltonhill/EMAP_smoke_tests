package jamestests.Logged_In_User_Tests.RegisteredUsers.MetaData;
...
public class RegUserLoginRetailWeekMetaDataTest {
    ...
    public void checkForSeg4MetaTag(){
        ...
        assertThat(seg4MetaTag.getAttribute("content"), is("LSB"));
